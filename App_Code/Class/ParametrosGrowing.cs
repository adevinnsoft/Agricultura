...
using System.Data.SqlClient;
    ...
    public class ParametrosGrowing
    {
        ...
        private int idParametroPorGrupoGrowing = 0;
        ...
        public int ParametroPorGrupoGrowing
        {
            get { return this.idParametroPorGrupoGrowing; }
            set { this.idParametroPorGrupoGrowing = value; }
        }
        ...
        public DataTable ObtenerListaPorGrupo()
        {
            ...
            try
            {
                ...
                cmdQuery = new SqlCommand("spr_ObtenerListasParametroPorGrupoGrowing", cnnMain);
        ...
        public DataTable ObtenerDetalleListaPorGrupo(string Tipo)
        {
            DataTable functionReturnValue = null;
            SqlConnection cnnMain = new SqlConnection();
            SqlCommand cmdQuery = null;
            ...
            try
            {
                if (Tipo == "NAOKX")
                {
                    cmdQuery = new SqlCommand("spr_ObtenerListasSubParametroPorGrupoGrowingNA_OK_X", cnnMain);
                    cmdQuery.CommandType = CommandType.StoredProcedure;
                    cmdQuery.Parameters.Clear();
                }
                ...
                if (Tipo == "SAGN")
                {
                    cmdQuery = new SqlCommand("spr_ObtenerListasSubParametroPorGrupoGrowingS_A_G_N", cnnMain);
                    cmdQuery.CommandType = CommandType.StoredProcedure;
                    cmdQuery.Parameters.Clear();
                }
                cnnMain.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["dbConn"].ToString();
