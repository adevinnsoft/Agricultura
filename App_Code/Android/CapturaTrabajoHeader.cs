...
/// <summary>
/// Descripción breve de CapturaTrabajoHeader
/// </summary>
public class CapturaTrabajoHeader
{



    public CapturaTrabajoHeader()
    {
        //
    ...
    public int idCapturaHeader { get; set; }
    public int idCapturaHeaderLocal { get; set; }
    ...
    public DataRow toDataRow(DataTable dt)
    {
        ...
        dr["idCapturaHeader"] = this.idCapturaHeader;
        dr["idCapturaHeaderLocal"] = this.idCapturaHeaderLocal;
