...
/// </summary>
public class EmbarqueFormasAAndroidV2
{
    ...
    public int idSubPlantaDescarga { get; set; }

    public EmbarqueFormasAAndroidV2()
    {
        //
    ...
    public DataTable toDataTable()
    {
        ...
        dt.Columns.Add("idSubPlantaDescarga");
        return dt;
    }
    ...
    public DataRow toDataRow(DataTable dt)
    {
        ...
        dr["idSubPlantaDescarga"] = this.idSubPlantaDescarga;
        return dr;
