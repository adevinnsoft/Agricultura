<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCargaDRP.aspx.cs" Inherits="pages_frmCargaDRP" Title="" MasterPageFile="~/MasterPage.master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2>Programación semanal y cosecha</h2>
        <asp:GridView cellspacing="0" rules="all" border="1" ID="gv_cosecha" style="border-collapse:collapse;" runat="server" AutoGenerateColumns="true" >
            
        </asp:GridView>
        <h2>Embarques</h2>
        <asp:GridView cellspacing="0" rules="all" border="1" ID="gv_embarques" style="border-collapse:collapse;" runat="server" AutoGenerateColumns="true">
            
        </asp:GridView>
        <h2>Growing</h2>
        <asp:GridView cellspacing="0" rules="all" border="1" ID="gv_growing" style="border-collapse:collapse;" runat="server" AutoGenerateColumns="true">
    ...
    <table class="index">
      <tr><td colspan="4"> <input type="button" id="btn_GuardarTabla" value="Guardar" onclick="return btn_GuardarTabla_onclick()" /></td></tr>
     </table>
    </div>
