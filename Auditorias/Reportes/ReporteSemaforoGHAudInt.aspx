<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteSemaforoGHAudInt.aspx.cs" Inherits="Auditorias_Reportes_ReporteSemaforoGHAudInt" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
        <title>Reporte Semaforo/GH de Auditorias Internas</title>
        ...
        <style>
            ...
            #tablaReporte table, .tblDetalles table {
                border-collapse: collapse;
                width: 100%;
            }

            #tablaReporte th, .tblDetalles th{
                padding: 8px;
                border-bottom: 2px solid #3c3b3b;
            }

            #tablaReporte td, .tblDetalles td {
                padding: 8px;
                text-align: left;
                border-bottom: 2px solid #3c3b3b;
            }
...
<div class="container">
            ...
            <div id="filtros" style="margin: 0px auto; width: 100%; height: auto;">
                <table style="margin:0px auto; width:100%;">
                    <tr>
                        ...
                        <td class="centro">
                            <asp:Button ID="btnPrint" Visible="false" OnClick="btnPrint_Click" runat="server" Text="Exportar Excel" />
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div id="Detalles">
                <p style="margin:0px auto; width:100%; height:auto;">
                    <h3 class='centro'>Reporte Semaforo/GH de Auditorias Internas</h3>
                </p>
                <br />
