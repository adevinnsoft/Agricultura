<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteSemanalAudExt.aspx.cs" Inherits="Auditorias_Reportes_ReporteSemanalAudExt" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
        <title>Reporte de Auditorias Externas</title>
...
<div class="container">
            ...
            <div id="Detalles">
                <p style="margin:0px auto; width:100%; height:auto;">
                    <h3 class='centro'>Reporte de Auditorias Externas</h3>
                </p>
                <br />
