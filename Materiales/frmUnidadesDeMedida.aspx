<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmUnidadesDeMedida.aspx.cs" Inherits="Materiales_frmUnidadesDeMedida"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <script type="text/javascript" src="../comun/Scripts/jquery-1.7.2.min.js"></script>
    ...
    <style type="text/css">
        input#ctl00_ContentPlaceHolder1_txtUnidadMedida, input#ctl00_ContentPlaceHolder1_txtUnidadMedida_EN
        {
            min-width: 159px;
        }
    </style>
    ...
    <div class="container">
        ...
        <asp:Panel ID="form" runat="server" meta:resourcekey="formResource1">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:HiddenField ID="hdnIdUnidadMedida" runat="server" />
                    <table class="index">
                        <tr>
                        ...
                        <tr>
                            <td align="right">
                                <asp:Literal ID="ltUnidadMedida" runat="server" meta:resourcekey="ltUnidadMedidaResource1"></asp:Literal>
                            </td>
                            <td align="left" style="text-align: left;">
                                <asp:TextBox ID="txtUnidadMedida" runat="server" meta:resourcekey="txtUnidadMedidaResource1" CssClass="required"></asp:TextBox><asp:Label ID="lngSp" runat="server" meta:resourceKey="lngSp"
                         ...
                         <tr>
                            ...
                            <td align="left" style="text-align: left;">
                                <asp:TextBox ID="txtUnidadMedida_EN" runat="server"  CssClass="required"
                                    meta:resourcekey="txtUnidadMedida_ENResource1"></asp:TextBox><asp:Label ID="lngEn" runat="server" meta:resourceKey="lngEn"
                                        CssClass="lengua"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left" style="text-align: left;">
                                <asp:TextBox ID="txtDescripcion" CssClass="required" runat="server" 
                                    TextMode="MultiLine" Rows="3" meta:resourcekey="txtDescripcionResource1"></asp:TextBox> <asp:Label ID="Label1" runat="server" meta:resourceKey="lngEn"
                                        CssClass="lengua"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left" style="text-align: left;">
                                <asp:TextBox ID="txtDescription_EN" CssClass="required" runat="server" 
                                    TextMode="MultiLine" Rows="3" meta:resourcekey="txtDescription_ENResource1"></asp:TextBox> <asp:Label ID="Label2" runat="server" meta:resourceKey="lngSp"
                                        CssClass="lengua"></asp:Label>
                            </td>
                        </tr>
                        <tr><td colspan="2">&nbsp;</td>
                        <td colspan="2">
                            <asp:Button ID="btnSave" runat="server" meta:resourcekey="btnSaveResource1" CssClass="btnSave"  onclick="btnSave_Click" />
            ...
            <div class="grid">
                ...
                <asp:GridView ID="gvUnidadMedida" runat="server" AutoGenerateColumns="False" CssClass="gridView" EmptyDataText="No Data" ShowHeaderWhenEmpty="true"
                    meta:resourcekey="GridView1Resource1" DataKeyNames="IdUnidadMedida" onprerender="gvUnidadMedida_PreRender" 
                    onrowdatabound="gvUnidadMedida_RowDataBound" 
                    onselectedindexchanged="gvUnidadMedida_SelectedIndexChanged">
                    ...
                    <Columns>
                     <asp:TemplateField meta:resourcekey="TemplateFieldResource1" 
                        ...
                        <asp:BoundField DataField="Nombre" HeaderText="Nombre" 
                            SortExpression="Nombre" meta:resourcekey="BoundFieldResource1" >
                        <HeaderStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                     ...
                     <%--   <asp:TemplateField meta:resourcekey="TemplateFieldResource2" 
                        SortExpression="vNombre">
                        
                        <ItemTemplate>

                            <asp:Label ID="lblUsuariogrid" runat="server" Enabled="False" 
