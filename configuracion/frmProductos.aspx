<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmProductos.aspx.cs" Inherits="configuracion_frmProductos"  EnableEventValidation="false" meta:resourcekey="PageResource1"%>
    ...
    <div class="container">
        ...
        <asp:Panel ID="form" runat="server" meta:resourceKey="formResource1">
                ...
                <asp:HiddenField id="hdnIdPlanta" runat="server" />
                    <table class="index">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:TextBox id="txtProducto" runat="server" meta:resourceKey="txtEtapaResource"></asp:TextBox>
                            </td>
                             <td align="right">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                 <asp:Literal ID="ltCodigo" runat="server" meta:resourceKey="ltCodigoResource"></asp:Literal>
                                 *</td>
                            <td>
                                <asp:TextBox ID="txtCodigo" runat="server" meta:resourceKey="txtNombreCortoResource"></asp:TextBox>
                            </td>
            ...
            <div class="grid">
                ...
                DataKeyNames="idProduct" meta:resourcekey="GvPlantasResource1"  
                    ...
                    <asp:BoundField DataField="Descripcion" SortExpression="Descripción" 
