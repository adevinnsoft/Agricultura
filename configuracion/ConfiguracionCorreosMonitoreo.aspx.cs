...
public partial class configuracion_ConfiguracionCorreosMonitoreo : BasePage
{
    private static readonly ILog log = LogManager.GetLogger(typeof(configuracion_ConfiguracionCorreosMonitoreo));
    public static int idCapturaDefault = 1;
