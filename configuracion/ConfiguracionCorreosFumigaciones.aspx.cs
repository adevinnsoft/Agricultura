...
public partial class configuracion_ConfiguracionCorreosFumigaciones : BasePage
{
    private static readonly ILog log = LogManager.GetLogger(typeof(configuracion_ConfiguracionCorreosFumigaciones));
    public static int idCapturaDefault = 4;
    ...
    public static string[] buscarEnActiveDirectory(string SAMaccount)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                sb.AppendLine("<span><label for=\"lblCuenta\" class=\"lblCuenta\">Cuenta:</label><label class=\"lblCuentaMostrado\">" + SAMaccount + "</label></span>");
                sb.AppendLine("<img src=\"../comun/img/add-icon.png\" id=\"btnAgregarFumigaciones\" class=\"botonAgregar\" onclick=\"agregarCorreos()\">");
