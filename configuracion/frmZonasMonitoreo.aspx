<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmZonasMonitoreo.aspx.cs" Inherits="configuracion_frmZonasMonitoreo" EnableEventValidation="false" meta:resourcekey="PageResource1"%>
...
<div class="container">
        ...
        <asp:Panel ID="form" runat="server" DefaultButton="btnHidden" 
            ...
            <table class="index">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtZona" Width="350px" MaxLength="50" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtZona_EN" Width="350px" MaxLength="50" 
              ...
              <td colspan="2"><div runat="server" id="AgreNiv"></div></td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        CssClass="btnSave" 
                                  meta:resourcekey="btn_EnviarResource1">
                    </asp:Button>
        ...
        AutoGenerateColumns="False" DataKeyNames="idZona" OnPageIndexChanging="gv_ZonaMonitor_PageIndexChanging"
        ...
        ForeColor="#333333" GridLines="None"  
            ...
            <Columns>
                <asp:BoundField DataField="vZona" HeaderText="Zona" 
