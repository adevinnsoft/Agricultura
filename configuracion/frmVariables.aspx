<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmVariables.aspx.cs" Inherits="configuracion_frmVariables" EnableEventValidation="false" meta:resourcekey="PageResource1"  %>
    ...
    <div class="container">
        ...
        <asp:Panel ID="form" runat="server" meta:resourceKey="formResource1">
                ...
                <asp:HiddenField id="hdnIdPlanta" runat="server" />
                    <table class="index">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:TextBox id="txtCodigoVariable" runat="server" meta:resourceKey="txtEtapaResource"></asp:TextBox>
                            </td>
                             <td align="right">
            ...
            <div class="grid">
                ...
                DataKeyNames="idVariable" meta:resourcekey="GvPlantasResource1"  
                    ...
                    <asp:BoundField DataField="codigoVariable" SortExpression="codigoVariable" 
