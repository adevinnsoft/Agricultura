...
public partial class configuracion_ConfiguracionCorreosPreHarvest : BasePage
{
    private static readonly ILog log = LogManager.GetLogger(typeof(configuracion_ConfiguracionCorreosPreHarvest));
    public static int idCapturaDefault = 2;
        ...
        string nombreCuenta = DGActiveDirectory.obtenerInformacionDeLaCuenta(SAMaccount, DGActiveDirectory.PROPIEDAD.NombreAMostrar);
            ...
            try
            {
                ...
                else
                {
                    ...
                    sb.AppendLine("<img src=\"../comun/img/add-icon.png\" id=\"btnAgregarPreHarvest\" class=\"botonAgregar\" onclick=\"agregarCorreos()\">");
    ...
    //[WebMethod]
    //public static string[] eliminarCorreo(string correo){
    ...
    //    {
    //        log.Error(ex);
    //        return new string[] { "0", "No se pudo eliminar el correo seleccionado", "error" };
    //    }
    //}
    ...
    //[WebMethod]
    //public static string[] sendMail(List<String> To, string Subject, string Message)
    //{
    //    EnviarCorreo sender = new EnviarCorreo();
    //    bool enviado = false;
    //    bool esMail = false;
    //    try
    //    {
    //        if (To.Count == 0 || Subject == "" || Message == "")
    //        {
    //            return new string[] { "0", "Datos incompletos", "warning" };
    //        }
    //        else
    //        {
    //            foreach (String mail in To)
    //            {
    //                if (sender.validateMail(mail) == true)
    //                {
    //                    esMail = true;
    //                }
    //                else
    ...
    //            if (esMail)
    //            {
    //                sender.Enviar(To, Subject, Message);
    //                enviado = true;
    //            }
    //            else
    //            {
    ...
    //        if (enviado)
    //        {
    //            return new string[] { "1", "Mensaje enviado con exito", "ok" };
    //        }
    //        else
    //        {
    //            return new string[] { "0", "Error al enviar el Mensaje", "error" };
    //        }

    //    }
    //    catch (Exception)
    //    {
    //        return new string[] { "0", "Error de ejecucion", "error" };
