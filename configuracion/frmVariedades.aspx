<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmVariedades.aspx.cs" Inherits="configuracion_frmVariedades" EnableEventValidation="false" meta:resourcekey="PageResource1" %>
    ...
    <div class="container">
        ...
        <asp:Panel ID="form" runat="server" meta:resourceKey="formResource1">
                ...
                <asp:HiddenField id="hdnIdPlanta" runat="server" />
                    <table class="index">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:TextBox id="txtVariedad" runat="server" meta:resourceKey="txtEtapaResource"></asp:TextBox>
                            </td>
                            
                           
                            <td> *<asp:Literal ID="ltProducto" runat="server" meta:resourceKey="ltProductoResource"></asp:Literal></td>
                        ...
                        <tr>
                            <td align="right">
                                 *<asp:Literal ID="ltDescripcion" runat="server" meta:resourceKey="ltDescripcionResource"></asp:Literal>
                            </td>
                            <td align="right">
                                <asp:TextBox id="txtDescripcion" runat="server" meta:resourceKey="txtNombreCortoResource"></asp:TextBox>
                            </td>
            ...
            <div class="grid">
                ...
                DataKeyNames="idVariety" meta:resourcekey="GvPlantasResource1"  
                    ...
                    <asp:BoundField DataField="Product" SortExpression="Producto" 
                             meta:resourcekey="BoundFieldResource1" >
                        <HeaderStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Variety" SortExpression="Variedad" 
                             meta:resourcekey="BoundFieldResource2" >
                        <HeaderStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Description"   meta:resourcekey="BoundFieldResource7"
