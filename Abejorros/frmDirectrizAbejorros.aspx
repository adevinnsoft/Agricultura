<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmDirectrizAbejorros.aspx.cs" Inherits="frmDirectrizAbejorros" %>
        ...
        function cargaDeDirectricesHistoricas() {
            PageMethods.GuardadasRecientemente(function (response) {
                ...
                $('.cargarTablaDirectriz').click(function () {
                    var idDirectriz = $(this).attr('id');
                    PageMethods.DirectrizObtenerTabla(idDirectriz, function (response) {
                        $('.grid').html(response);
                        funcionesDelGrid();
        ...
        $(function () {
            ...
            $('#btn_GuardarTabla').click(function () {
                if ($('#gv_Directriz').length > 0) {
                    ...
                    //});
                    //$('#chkl_Variable.ClientI input:checked').parent().find('.invisible').each(function () {
                    ...
                    //var interplanting = $('#hkInterplanting.ClientID').prop("checked");
                    var Errores = '';
                    ...
                    if (Errores.length == 0) {
                        PageMethods.GuardarDirectriz(matriz.split('|'), nombreDeDirectriz, idTemporal.substring(0, idTemporal.length - 1), idPlanta, function (resultado) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="grid" id="divGrid" runat="server">
        ...
        <%--<asp:GridView runat="server" ID="gv_Directriz" CssClass="grid"></asp:GridView>--%>
    <table class="index">
       <tr><td><asp:Label ID="lblNombre" runat="server" Text="Nombre de Directriz:"></asp:Label></td><td colspan="3"><asp:TextBox ID="txtNombre" runat="server" Width="90%"></asp:TextBox></td></tr>
       <%--
